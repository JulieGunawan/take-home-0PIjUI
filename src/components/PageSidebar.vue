        ...
        <div  v-if="activateFilter" >
            <div class="flex flex-col gap-2 p-2 w-[80%]">   
                <div class="bg-gray-200 flex flex-col w-full p-2 md:p-3 xl:p-4 rounded gap-2">
                    ...
                    <input type="text" class="w-full p-2 text-sm xl:text-base rounded-md" v-model="filters.firstName" placeholder="First Name" >
                </div>
                <div class="bg-gray-200 flex flex-col w-full p-2 md:p-3 xl:p-4  rounded gap-2">
                    <label class="text-sm xl:text-base" > 
                        Last Name:
                    </label>
                    <input type="text" class="w-full p-2 text-sm xl:text-base rounded-md"  v-model="filters.lastName" placeholder="Last Name">
                </div>
                <div class="bg-gray-200 flex flex-col w-full p-2 md:p-3 xl:p-4 gap-2">
                    <label class=" text-sm xl:text-base" >
                        Plan: 
                    </label>
                    <select class="w-full p-2 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white text-sm xl:text-base"  
